...
public sealed record CreateConversationRequest([MaxLength(160)] string? Title);
...
public sealed record SendMessageRequest([Required, MaxLength(8000)] string Content);
